...
<script type="text/javascript">
	var searchRequest = new XMLHttpRequest();	// 웹사이트에 요청을 보내는 객체 생성
	var registerRequest = new XMLHttpRequest();
	function searchFunction() {
		searchRequest.open("Post", "./UserSearchServlet?userID=" + encodeURIComponent(document.getElementById("userID").value), true);
	...
	function registerFunction() {
		registerRequest.open("Post", "./UserRegisterServlet?userID=" + encodeURIComponent(document.getElementById("registerName").value) +
	...
	<div class="container">
		<table class="table" style="text-align : center; border : 1px solid #dddddd">
			...
			<tbody>
				...
				<tr>
					<td colspan="2"><button class="btn btn-primary pull-right" onclick="registerFunction()">등록</button></td>
				</tr>
			</tbody>
		</table>
	</div>
